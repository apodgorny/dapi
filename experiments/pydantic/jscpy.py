...
if __name__ == "__main__":
    # Example schema with composite types (anyOf, allOf, oneOf)
    schema = {
        "type": "object",
        "properties": {
            "id": {"type": "string"},
    ...
    Model = json_schema_to_pydantic(schema, base_class=MyBaseModel, class_name="MyModel")
    
    # Instantiate the model
    instance = Model(
        id="12345",
        value="test_string",  # Could also be a number or boolean
        nested={
            "tags": ["tag1", "tag2"],
            "options": "option_string"  # Could also be a string array
        },
        merged={
            "name": "John",
            "age": 30
